...
def subject(income_for_tax):
    '''
    The function calculates the amount of the annual tax for a given entity.
    '''
    if income_for_tax < 9_076:
        ...
        tax = (0.1*9_075 + 0.15*27_825 + 0.25*52_450 + 0.28*97_000 + 0.33*218_750 +
               0.35*(income_for_tax - 405_100))
        return tax
    else:
        tax = (0.1*9_075 + 0.15*27_825 + 0.25*52_450 + 0.28*97_000 + 0.33*218_750 +
               0.35*1_650 + 0.396*(income_for_tax - 406_750))
        return tax
...
def couple(income_for_tax):
    ...
    if income_for_tax < 18_151:
        ...
        tax = (0.1*18_150 + 0.15*55_650 + 0.25*75_050 + 0.28*78_000 + 0.33*178_250 +
               0.35*(income_for_tax - 405_100))
        return tax
    else:
...
def parent(income_for_tax):
    ...
    if income_for_tax < 12_951:
        ...
        tax = (0.1*12_950 + 0.15*36_450 + 0.25*78_150 + 0.28*79_050 + 0.33*198_500 +
               0.35*(income_for_tax - 405_100))
        return tax
    else:
        tax = (0.1*12_950 + 0.15*36_450 + 0.25*78_150 + 0.28*79_050 + 0.33*198_500 +
               0.35*27_100 + 0.396*(income_for_tax - 432_200))
        return tax
